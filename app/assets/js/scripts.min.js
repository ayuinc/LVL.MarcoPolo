...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    $(document).ready(function() {
        ...
        d = new ScrollMagic.Controller(), d.scrollTo(function(a) {
            ...
            b = $("a", this).attr("href"), console.log(b), $(".filter-triggers li").removeClass("active"), 
            $(".site-wrapper").addClass("filters-on"), $(this).addClass("active"), $(".filters-wrapper").find(b).addClass("on-screen");
