...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    $(document).ready(function() {
        ...
        }, $(".filter-triggers a").click(function(a) {
            var b;
            a.preventDefault(), e(), $(".filters-wrapper [class*=filter-module-]").removeClass("on-screen"), 
            b = $(this).attr("href"), console.log(b), $(".filter-triggers li").removeClass("active"), 
            $(".site-wrapper").addClass("filters-on"), $(this).parent().addClass("active"), 
            $(".filters-wrapper").find(b).addClass("on-screen");
