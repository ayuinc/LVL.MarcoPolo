...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("TweenMax", [ "core.Animation", "core.SimpleTimeline", "TweenLite" ], function(a, b, c) {
        ...
        e.render = c.render, j.invalidate = function() {
            ...
            1 === l ? this.ratio = 1 - j : 2 === l ? this.ratio = j : this._time / s < .5 ? this.ratio = j / 2 : this.ratio = 1 - j / 2) : this.ratio = this._ease.getRatio(this._time / s)), 
        ...
        return k.constructor = d, k.kill()._gc = !1, d.version = "1.16.1", k.invalidate = function() {
            ...
            a = o + 1e-4) : this._time < 0 ? this._time = a = 0 : a = this._time));
        ...
        j.scaleX = j.scaleY = j.scaleZ = 1, sa("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
            ...
            parser: function(a, b, c, f, g, h) {
                ...
                k = parseFloat(l) + p + s)), g = pa(z, y[j], m + " " + l, n + " " + k, !1, "0px", g);
                return g;
            },
            prefix: !0,
        ...
        init: function(a, b, c) {
            ...
            for (d in b) this._start[d] = this._proxy[d] = e = a.getAttribute(d), f = this._addTween(this._proxy, d, parseFloat(e), b[d], d), 
            this._end[d] = f ? f.s + f.c : b[d], this._overwriteProps.push(d);
            return !0;
        },
        set: function(a) {
