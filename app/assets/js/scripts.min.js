...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    $(document).ready(function() {
        ...
        }, $(window).width() > 768 && ($(".filter-triggers li").click(function(a) {
            var b;
            a.preventDefault(), e(), $(".filters-wrapper [class*=filter-module-]").removeClass("on-screen"), 
        ...
        })), a = $(".gallery"), a.flickity({
            cellAlign: "left",
            contain: !0,
            wrapAround: !0,
            pageDots: !1,
            prevNextButtons: !1
        }), b = $(".gallery-control-left"), c = $(".gallery-control-right"), b.on("click", "a", function(b) {
            b.preventDefault(), a.flickity("previous");
        }), c.on("click", "a", function(b) {
            b.preventDefault(), a.flickity("next");
        });
    });
}.call(this), function() {
    "use-strict";
