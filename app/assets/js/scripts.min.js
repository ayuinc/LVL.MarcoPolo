    ...
    $(document).ready(function() {
        ...
        $(".disable-anchors a").click(function(a) {
            ...
            a.preventDefault(), $("body").css({
                overflow: "hidden"
            }), $(".filters-wrapper [class*=filter-module-]").removeClass("on-screen"), b = $(this).attr("href"), 
            console.log(b), $(".filter-triggers li").removeClass("active"), $(".site-wrapper").addClass("filters-on"), 
            $(this).parent().addClass("active"), $(".filters-wrapper").find(b).addClass("on-screen");
